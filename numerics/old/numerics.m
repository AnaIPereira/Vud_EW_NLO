...
J1[mu,5]/.g0->-4/.g1->gaux1 (*overall sign difference*)


J2[mu,5]/.g2->1


ad[2]/.g2->1/.g0->1/.g1->gaux1//Expand
...
ad /: ad[2]:= g2 (-((14016 + 1016*a1qu + 6*a1qu^2 - 192*a2qu - 63*b1qu + 6*b2qu)*(ne qe^2 + nd nc qd^2 + nu nc qu^2)) - 
  ...
  24*(-562 + 9*(ne qe^4 + nd nc qd^4 + nu nc qu^4)*(62 + a1qu - 96*Zeta[3])))/324/.nc->3/.ne->3/.nu->2/.nd->3/.qd->-1/3/.qe->-1/.qu->2/3;
