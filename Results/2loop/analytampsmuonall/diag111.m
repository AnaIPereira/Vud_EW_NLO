...
-1/8192*(el^6*Ev3*(MW^6*sorttad[{0, 0, MW}, {1, 1, 1}] - 
     ...
     MW^4*MZ^2*sorttad[{MW, MW, MZ}, {1, 1, 1}] - 
     MW^2*MZ^4*sorttad[{MW, MW, MZ}, {1, 1, 1}]))/
   (cw^2*MW^4*(MW - MZ)^2*MZ^2*(MW + MZ)^2*Pi^8*sw^2) - 
 (el^6*Op*(-4*MW^6*sorttad[{0, 0, MW}, {1, 1, 1}] + 
    ...
    4*MW^4*MZ^2*sorttad[{MW, MW, MZ}, {1, 1, 1}] + 
    4*MW^2*MZ^4*sorttad[{MW, MW, MZ}, {1, 1, 1}]))/
  (8192*cw^2*MW^4*(MW - MZ)^2*MZ^2*(MW + MZ)^2*Pi^8*sw^2)
