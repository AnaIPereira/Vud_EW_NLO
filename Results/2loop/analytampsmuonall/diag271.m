...
(Ev3*(-1 + 2*sw^2)*
   (-(el^6*auxdensimp[{0, 0, 0}, {}, {{0, 2}, {MW, 1}, {MZ, 1}}, {}]*
    ...
    el^6*auxdensimp[{0, 0, 1}, {{0, 1}}, {{0, 2}, {MW, 1}, {MZ, 1}}, {}]*
     Flag[tadpolem]*NF[{MM}]))/(4096*cw^2*Pi^8*sw^4) + 
 (Op*(-1 + 2*sw^2)*(-16*el^6*auxdensimp[{0, 0, 0}, {}, 
      {{0, 2}, {MW, 1}, {MZ, 1}}, {}]*Flag[tadpolem]*NF[{MM}] - 
    16*el^6*auxdensimp[{0, 0, 0}, {{0, 1}}, {{0, 1}, {MW, 1}, {MZ, 1}}, {}]*
     Flag[tadpolem]*NF[{MM}] + 16*el^6*auxdensimp[{0, 0, 1}, {{0, 1}}, 
      {{0, 2}, {MW, 1}, {MZ, 1}}, {}]*Flag[tadpolem]*NF[{MM}]))/
  (4096*cw^2*Pi^8*sw^4)
