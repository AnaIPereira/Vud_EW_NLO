...
(el^6*Ev3*MT^2*(-2*QFTSymbols`MW^2*MZ + MZ^3)^2*nc*Flag[tadpolem]*
   NF[{MT}, {MW}]*(-2*MZ^4*sorttad[{0, MT, MW}, {0, 1, 1}] + 
    MW^2*((-4 + d)*MW^2 - (-6 + d)*MZ^2)*sorttad[{0, MT, MZ}, {0, 1, 1}]))/
  (2048*d*MH^2*MW^2*QFTSymbols`MW^4*(MW - MZ)^2*(MW + MZ)^2*
   (QFTSymbols`MW^2 - MZ^2)^3*Pi^8) - 
 (el^6*MT^2*(-2*QFTSymbols`MW^2*MZ + MZ^3)^2*nc*Op*Flag[tadpolem]*
   NF[{MT}, {MW}]*(-2*MZ^4*(MZ^2 - MW^2*\[Xi]w)^2*(MW^2*\[Xi]w - MZ^2*\[Xi]z)^
      2*(5*(-4 + d)*MZ^4*\[Xi]z^2 + 2*MW^2*MZ^2*\[Xi]z*
       (19 + \[Xi]z - d*(4 + \[Xi]z)) + MW^4*(-19 - \[Xi]z^2 + 
        d*(4 + \[Xi]z^2)))*sorttad[{0, MT, MW}, {0, 1, 1}] + 
