...
(el^6*Ev3*(-2*QFTSymbols`MW^2*MZ + MZ^3)^2*Flag[selfm]*
   ((-((-6 + d)*MW^2*MZ^2) + (-4 + d)*MZ^4)*sorttad[{0, MW, MW*Sqrt[\[Xi]w]}, 
      {0, 1, 1}] - 2*MW^4*sorttad[{0, MZ, MW*Sqrt[\[Xi]w]}, {0, 1, 1}]))/
  (8192*d*MW^4*QFTSymbols`MW^2*(MW^2 - MZ^2)^2*(QFTSymbols`MW^2 - MZ^2)^3*
