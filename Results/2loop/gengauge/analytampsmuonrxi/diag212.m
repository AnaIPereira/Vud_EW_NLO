...
(el^6*Ev3*(2*QFTSymbols`MW^2*MZ^4 - MZ^6)*Flag[selfm]*
  ...
  (16384*d*QFTSymbols`MW^4*(QFTSymbols`MW^2 - MZ^2)^3*(MW^3 - MW*MZ^2)^2*
   ...
   (-2*MZ^4*(MZ^2 - MW^2*\[Xi]w)^2*(MW^2*\[Xi]w - MZ^2*\[Xi]z)^2*
    ...
    MW^2*((-6 + d)*MZ^6*(17 + d*(-2 + \[Xi]w) - \[Xi]w) + 
     ...
     sorttad[{0, MZ, MH}, {0, 1, 1}] - (MW^2 - MZ^2)^2*
