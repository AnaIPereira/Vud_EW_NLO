...
(el^6*Ev3*MZ^2*Flag[selfm]*((MW^3 - MW*MZ^2)^2*\[Xi]w*
     (MW^2*\[Xi]w + MZ^2*(1 - d + 2*\[Xi]w))*sorttad[{0, 0, MW*Sqrt[\[Xi]w]}, 
      {1, 1, 1}] + MZ^4*(MW^2*(-4 + d - 3*\[Xi]w) + MZ^2*(3 - d + 2*\[Xi]w))*
  ...
  (8192*(-1 + d)*d*MW^4*QFTSymbols`MW^2*(MW^2 - MZ^2)^2*
   (QFTSymbols`MW^2 - MZ^2)^2*Pi^8) + 
 (el^6*MZ^2*Op*Flag[selfm]*((-3 + d)*MW^2*(MW^2 - MZ^2)^2*\[Xi]w*
     (-MZ^2 + MW^2*\[Xi]w)*((20 - 6*d + d^2)*MW^2*\[Xi]w - 
      MZ^2*(-11*d^2 + d^3 + 10*d*(3 + \[Xi]w) - 20*(1 + 2*\[Xi]w)))*
     (MW^2 - MZ^2*\[Xi]z)^2*(MW^2*\[Xi]w - MZ^2*\[Xi]z)*
     sorttad[{0, 0, MW*Sqrt[\[Xi]w]}, {1, 1, 1}] + 
    (-3 + d)*MZ^4*(MZ^2 - MW^2*\[Xi]w)*(-(MW^2*\[Xi]w) + MZ^2*\[Xi]z)*
     (5*(-4 + d)*MZ^6*(-3 + d - 2*\[Xi]w)*\[Xi]z^2 - MW^6*(-4 + d - 3*\[Xi]w)*
       (-19 - \[Xi]z + d*(4 + \[Xi]z)) - MW^2*MZ^4*\[Xi]z*
       (118 + 82*\[Xi]z + d^2*(9 + 6*\[Xi]z) + \[Xi]w*(79 + 61*\[Xi]z) - 
        d*(67 + 43*\[Xi]z + \[Xi]w*(19 + 16*\[Xi]z))) + 
      MW^4*MZ^2*(57 + 160*\[Xi]z + 3*\[Xi]z^2 + 
        d^2*(4 + 10*\[Xi]z + \[Xi]z^2) + 2*\[Xi]w*(19 + 60*\[Xi]z + 
          \[Xi]z^2) - d*(31 + 80*\[Xi]z + 4*\[Xi]z^2 + 
          2*\[Xi]w*(4 + 15*\[Xi]z + \[Xi]z^2))))*
     sorttad[{0, MW, MW*Sqrt[\[Xi]w]}, {0, 1, 1}] + 
