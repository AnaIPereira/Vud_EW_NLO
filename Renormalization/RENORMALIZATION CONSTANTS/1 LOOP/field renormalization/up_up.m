...
{SMP["m_b"]->mf,SMP["m_s"]->mf,SMP["m_c"]->mf,SMP["m_u"]->mf,SMP["m_d"]->mf,SMP["m_e"]->me,SMP["m_mu"]->mmu,SMP["m_tau"]->mtau,
...
amplitudewtotList3[[1]]
Export["/home/ana/Desktop/comp.m",%]
...
amplitudewtotList8[[1]]/.
{DiracGamma[6]->0}//.{Dot[DiracGamma[Momentum[p,D],D],0]->0}/.
{\!\(\*
TagBox[
StyleBox[
RowBox[{"Dot", "[", 
...
ShowStringCharacters->True,
NumberMarks->True],
FullForm]\)->p^2 \[Gamma]7}/.{DiracGamma[7]->\[Gamma]7}/.
{Dot[DiracGamma[Momentum[p]],\[Gamma]7]->pslash \[Gamma]7}/.\[Xi]A->1//Expand;
integrate@%
series@%
...
amplitudewtotList9[[1]]


amplitudewtotList9[[1]]//Expand
...
NumberMarks->True],
FullForm]\)->p^2 \[Gamma]7}/.{DiracGamma[7]->\[Gamma]7}/.
{Dot[DiracGamma[Momentum[p]],\[Gamma]7]->pslash \[Gamma]7}/.{mf->0}
...
zudiv=-tot1/\[Gamma]7/pslash//Collect[#,{pslash,\[Gamma]7,\[Alpha]/Pi/\[Epsilon]},Expand]&


Export["/home/ana/Documents/GitHub/Leptonic-and-Semileptonic-decays/results/dzu1loop.m",zudiv]
